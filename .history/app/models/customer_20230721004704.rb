...
def canadian_postal_code_format
  ...
  validates :primary_postal_code,:alt_postal_code, allow_nil: true
  validates :primary_address, :primary_city, :alt_address, :alt_city, allow_nil: true, length: { maximum: 100 }
  validate :canadian_postal_code_format, if: -> { primary_postal_code.present? || alt_postal_code.present? }
