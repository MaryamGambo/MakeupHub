class CheckoutController < ApplicationController
  ...
  def success
    ...
    puts "provincs #{@customer_address[:province['GST']].to_f}"



    # Fetch the HST, GST, and PST values from the provinces table using the address province
    gst_rate = @customer_address[:province['GST']].to_f
    pst_rate = @customer_address[:province['GST']].to_f
    hst_rate = @customer_address[:province['GST']].to_f
