class CheckoutController < ApplicationController
    ...
    if customer_signed_in?
      ...
      if customer.primary_address.present?
        customer_address = {
          ...
          province: customer.primary_province # Assuming province has a 'name' attribute
        }
      else
        customer_address = {
          ...
          province: customer.alt_province # Assuming province has a 'name' attribute
        }
      end
    elsif session[:guest_address].present?
      # Customer is not logged in, but has an address saved in the session (guest checkout)
  ...
  def success
     ...
     address_province = checkout_session["metadata"]["customer_address"]["province"]
