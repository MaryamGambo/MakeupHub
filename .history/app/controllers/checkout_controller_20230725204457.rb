class CheckoutController < ApplicationController
  ...
  def create
    Stripe.api_key = sk_test_51NWNApLWAmfv3lbzck07Yc3aSlF7rjYRwNGnRZuuC4CT3GBtG9Aj8G4TxyMYLnAsTMJu62Qot8aTiWOCTqtwWkeU006K32di4r
    ...
    session = Stripe::Checkout::Session.create({
      ...
      mode: 'payment',
      success_url: "https://29f5-24-78-13-91.ngrok-free.app/checkout/success",
      cancel_url: "https://29f5-24-78-13-91.ngrok-free.app/checkout/cancel",
     })
