class CheckoutController < ApplicationController
  ...
  def create
    ...
    session = Stripe::Checkout::Session.create({
      ...
      mode: 'payment',
      success_url: "https://dba8-142-160-124-32.ngrok-free.app/checkout/success?session_id={CHECKOUT_SESSION_ID}",
      cancel_url: "https://dba8-142-160-124-32.ngrok-free.app/checkout/cancel",
      metadata: {
