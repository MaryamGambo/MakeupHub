class CheckoutController < ApplicationController
  ...
  @provinces_list = Province.all.map { |province| [province.name, province.name] }
  ...
  def calculate_taxes(subtotal)
    ...
    if customer_signed_in? && (current_customer.primary_address || current_customer.alt_address)
      ...
      puts "Guest Address in Session: #{session[:guest_address]}" # Add this line to print the guest_address
